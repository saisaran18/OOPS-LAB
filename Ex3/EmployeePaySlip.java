...
{
   double basicpay,da,hra,pf,fund,netsalary,grosssalary;
   AssociativeProfessor(String emp_name,int emp_id,String address,String mail_id,String mob_number,double bp)
   {
      super(emp_name,emp_id,address,mail_id,mob_number);
      basicpay = bp;
   }
...
public class EmployeePaySlip
{
  public static void main(String arg[])throws IOException
  {
    ...
    case 2:AssistantProfessor ap = new AssistantProfessor(name,id,add,mail,mob,bp);
           ...
           ap.disp();
           break;
    case 3:AssociativeProfessor assp = new AssociativeProfessor(name,id,add,mail,mob,bp);
           assp.getPaySlip();
           assp.disp();
           break;
